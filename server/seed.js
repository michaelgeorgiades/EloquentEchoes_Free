...
function seedDatabase() {
    return __awaiter(this, void 0, void 0, function () {
        var existingSpeakers, speakerData, categoryData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("Seeding database...");
                    return [4 /*yield*/, db_1.db.select().from(schema_1.speakers).limit(1)];
                case 1:
                    existingSpeakers = _a.sent();
                    if (existingSpeakers.length > 0) {
                        console.log("Database already seeded");
                        return [2 /*return*/];
                    }
                    console.log("Starting fresh seed...");
                    return [4 /*yield*/, db_1.db.insert(schema_1.speakers).values([
                            {
                ...
                case 2:
                    speakerData = _a.sent();
                    return [4 /*yield*/, db_1.db.insert(schema_1.categories).values([
                ...
                case 3:
                    ...
                    return [4 /*yield*/, db_1.db.insert(schema_1.speeches).values([
                            {
